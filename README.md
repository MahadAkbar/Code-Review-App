...
- Returns an analysis report with requirement fit, risks, security concerns, suggestions, and recommended changes.
...
3. Fill in `GITHUB_CLIENT_ID`, `GITHUB_CLIENT_SECRET`, and the API key for your chosen LLM provider.
